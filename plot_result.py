...
# SAVEFIG = False
SAVEFIG = True
figname = "suuport_meg_rcv1_news20_MSD"
# figname = "finance"
# figname = "rcv1_news20"
...
DICT_YTICKS = {
    'libsvm[dataset=rcv1.binary]': [1e4, 1e2, 1],
    'libsvm[dataset=news20.binary]': [1e4, 1e2, 1],
    'MEG': [1e3, 1e2, 1e1, 1],
...
for idx_data, dataset in enumerate(datasets):
    ...
    for idx_obj, objective in enumerate(objectives):
        ...
        #     )
        #     continue
        c_star = np.min(df2["objective_support_size"]) - FLOATING_PRECISION
